...
import static com.github.jan5757.restaurantvoting.web.ProfileController.REST_URL;
import static com.github.jan5757.restaurantvoting.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
public class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        UserTestData.USER_MATCHER.assertMatch(userRepository.findAll(), UserTestData.admin, UserTestData.guest, UserTestData.user2);
    }
